...
while (safeguard > 0) {
    ...
    for (let x = 0; x < cols; x++) {
        for (let y = 0; y < rows; y++) {
            ...
            const tl = getCell(x - 1, y - 1);
            const t = getCell(x, y - 1);
            const tr = getCell(x + 1, y - 1);
            const l = getCell(x - 1, y);
            const r = getCell(x + 1, y);
            const b = getCell(x, y + 1);
            const lb = getCell(x - 1, y + 1);
            const rb = getCell(x + 1, y + 1);
